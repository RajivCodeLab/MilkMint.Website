          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="flex flex-col items-start gap-4">
              ...
              <div className="mt-4">
                ...
                {qrSrc ? (
                  <img src={qrSrc} alt="QR code to download APK" className="w-40 h-40 rounded-md shadow-lg" />
                ) : (
                  <div className="w-40 h-40 flex items-center justify-center bg-gray-100 rounded-md text-gray-400">Loading…</div>
                )}
              </div>
            </div>
